...
let clear = function(pais,index){
    //clearThree(pais,index);
    //var allStaight = getAllStraight(pais);
    //var clone = [].concat(pais);
    //var needLaiz = 0;
    //var min = 100;
    //var firstClear = [];
    //var needCount = 0;
    //for(var i = 0 ; i < allStaight.length; i ++){
    //    var clone = [].concat(pais);
    //    clearStraight(clone,allStaight[i]);
    //
    //    if(needCount < min){
    //        min = needCount;
    //        firstClear = allStaight[i];
    //    }
    //}
    //if(!allStaight.length){
    //    min = getNeedCount(clone);
    //}
    //clearThree(pais,index);
    getNeedCount(pais);
    return max;
...
var member = {
    mahjong : [9,9,9,11,11,13,14,15,16,16,16,21,21,11]
}
...
//console.log(getNeedCount([ 0, 5, 0, 2, 0, 0, 0, 0, 2 ] ,0))
//console.log(max);
//test();
